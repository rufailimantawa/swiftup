...
@section('admin:content')
    <div class="p-1">
        <div class="bg-white p-2 pb-0 rounded">
            ...
            <a href="{{ route('roles.index') }}" class="btn bg-secondary text-white mb-2 me-2">Manage Roles</a>
            <a href="{{ route('users.index') }}" class="btn bg-secondary text-white mb-2 me-2">Manage Users</a>
        </div>
    </div>
